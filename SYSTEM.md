...
Python verifies state, dependencies, evidence files, media validity and implementation references. It does not judge beauty, originality or visual authority. Agent 07 judges those qualities from rendered evidence and reports findings to the owner; it does not redesign the work itself.
