...
| 10 | Media decision & handoff | 05 | render diagnosis, per-scene image decisions, conditional `SPT-*` storyboard, external `IH-*` briefs, returned-asset validation and placement map |
| 11 | Integration | 06 | final landing, real media, spatial states when selected, fallbacks, scene traversal and integrity snapshot |
