...
4. En G4 contrasta el resultado con la Experience Spine y el `Page visual narrative map`: compara explícitamente el hero final desktop/mobile con el hero `CMP-*` aprobado en G3, además de continuidad, ritmo, assets, formato, mecanismos, transiciones y fallback móvil. Bloquea un hero distinto sin desviación previa, cortes causales, efectos decorativos, tramos planos o media repetitiva.
