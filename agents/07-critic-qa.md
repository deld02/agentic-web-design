...
4. En G4 contrasta el resultado con la Experience Spine y el `Page visual narrative map`: continuidad de comprensión e intención, ritmo completo, necesidad de cada asset, formato correcto, elegibilidad de sticky/parallax/hover/vídeo/3D, transiciones y fallback móvil. Bloquea cortes causales, efectos decorativos, tramos involuntariamente planos, fondos que dañan lectura y assets que repiten el mismo trabajo.
