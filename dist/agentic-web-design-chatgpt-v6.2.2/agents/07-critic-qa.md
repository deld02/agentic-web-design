...
4. En G4 contrasta el resultado con el `Page visual narrative map`: ritmo completo, necesidad de cada asset, formato correcto, elegibilidad de sticky/parallax/hover/vídeo/3D, transiciones y fallback móvil. Bloquea efectos decorativos, tramos involuntariamente planos, fondos que dañan lectura y assets que repiten el mismo trabajo.
